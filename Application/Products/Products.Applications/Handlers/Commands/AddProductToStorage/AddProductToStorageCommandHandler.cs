...
internal class AddProductToStorageCommandHandler : IRequestHandler<AddProductToStorageCommand, GetProductDto>
{
    ...
    public AddProductToStorageCommandHandler(IBaseWriteRepository<Product> products, IMapper mapper, ICurrentUserService currentUserService, ICleanProductsCacheService cleanProductsCacheService)
    {
        _products = products;
        _mapper = mapper;
    ...
    public async Task<GetProductDto> Handle(AddProductToStorageCommand request, CancellationToken cancellationToken)
    {
        ...
        product.StorageId = request.StorageId;
