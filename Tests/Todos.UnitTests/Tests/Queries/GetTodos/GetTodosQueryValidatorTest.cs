...
public class GetProductsQueryValidatorTest : ValidatorTestBase<GetProductsQuery>
{
    public GetProductsQueryValidatorTest(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
    {
    }
